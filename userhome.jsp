...
<header id="header">
  <div class="intro text-center">
	...
	<h1 style="font-size:20px;float:right;">Welcome to Customer,<%= session.getAttribute("UserName") %><Br></h1>
			<br><br><Br><br>
    <a href="addworks.jsp" style="font-size:25px;">Add Works</a><br><br>
	<a href="viewconfirmatin.jsp" style="font-size:25px;">View Worker Requests</a><br><br>
	<a href="sendfeedback.jsp" style="font-size:25px;">Send Feedback</a><br><br>
