...
<tr><th>WorkId</th><th>WorkerName</th><th>Category</th><th>Amount(per day)</th><th>Operation</tH></tr>
<%@include file="DBConn.jsp" %>
<%
PreparedStatement pst=con.prepareStatement("select * from accpted_requests where customername=? and status=?");
String user=(String)session.getAttribute("UserName");
pst.setString(1,user);pst.setInt(2,0);
ResultSet rs=pst.executeQuery();
while(rs.next())
{
%>
<Tr><th><a target="_blank" href="viewwork.jsp?wid=<%= rs.getString(1) %>"><%= rs.getString(1) %></a></tH>
<th><a target="_blank" href="viewworker.jsp?wid=<%= rs.getString(2) %>"><%= rs.getString(2) %></a></tH>
<Th><%= rs.getString(3) %></th>
<Th><%= rs.getString(6) %></th>
<th><a href="acceptworker.jsp?wid=<%= rs.getString(1) %>">Accept/</a>
<a href="rejectworker.jsp?wid=<%= rs.getString(1) %>">Reject</a></th></tr>
<tr><th colspan=3><br><br>Click on WorkID / Worker Name to View Details</tH></tr>
