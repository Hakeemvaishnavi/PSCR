...
<header id="header">
  <div class="intro text-center">
	...
	<br><br><h2>Customer Details</h2><Br><br>
<table align="Center" style="font-size:20px;" border=2 width=100%>
<tr><Th>Name</th><th>EmailId</th><th>MobileNumber</th><th>address</th><th>City</th><th>State</th>
</tr>
...
%>
  ...
  <th><%= rs.getString(4) %></th>  <th><%= rs.getString(5) %></th>  <th><%= rs.getString(6) %></th>  <th><%= rs.getString(7) %></th>
  </TR>
  <%
}
%>
