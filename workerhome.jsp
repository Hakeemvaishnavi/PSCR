...
<header id="header">
  <div class="intro text-center">
	...
	<h1 style="font-size:20px;float:right;">Welcome to Workers,<%= session.getAttribute("UserName") %><Br></h1>
			<br><br><Br><br>
    <a href="workerviewworks.jsp" style="font-size:25px;">View Works</a><br><br>
	<a href="viewrating.jsp" style="font-size:25px;">View Ratings</a><br><br>
