...
<header id="header">
  <div class="intro text-center">
	...
	<h1 style="font-size:20px;float:right;">Welcome to Workers,<%= session.getAttribute("UserName") %><Br>,<a href="workerhome.jsp">Back</a></h1>
			<br><br><Br><br>
			<table align="center" border=2 style="font-size:20px;" width="100%">
<tr><th>WorkId</th><Th>Description</th><th>Location</th><th>PostedOn</th><th>Customer</th><th>Category</th><th>DateOfWork</th><th>Operation</th></tr>
...
PreparedStatement pst=con.prepareStatement("select * from works where category=? and status=?");
pst.setString(1,cate);pst.setInt(2,0);
ResultSet rs=pst.executeQuery();
while(rs.next())
{
%>
<tr><th><%= rs.getString(1) %></th><th><%= rs.getString(2) %></th><th><%= rs.getString(3) %></th><th><%= rs.getString(5) %></th><th><%= rs.getString(7) %></th><th><%= rs.getString(8) %></th><th><%= rs.getString(9) %></th>
<th><a href="expressinterest.jsp?wid=<%= rs.getString(1) %>&cid=<%= rs.getString(7) %>">Express Interest</a></th>
</tr>
<%
}
%></table>
