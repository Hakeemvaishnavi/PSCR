...
int status=0;
PreparedStatement pst1=con.prepareStatement("select * from accpted_requests where wid=? and workername=?");
pst1.setString(1,wid);pst1.setString(2,user);
...
{
PreparedStatement pst=con.prepareStatement("insert into accpted_requests values(?,?,?,?,?,?)");
pst.setString(1,wid);
...
<header id="header">
  <div class="intro text-center">
	...
	<h1 style="font-size:20px;float:right;">Welcome to Worker,<%= session.getAttribute("UserName") %><Br></h1>
			<br><br><Br><br>
			<table align="center" style="font-size:20px;">
			<form action="workerrespons111.jsp" method="post">
			<tr><th colspan=2>Enter Work Details</th></tr>
<tr><th>WorkID</th><th><input type="text" name="wid" value="<%= wid %>" required  style="color:black;"/><Br></th></tr>


<tr><th>Enter Amount</th><th><input type="number" name="amount" required  style="color:black;"/><Br></th></tr>
