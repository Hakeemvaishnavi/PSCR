...
<header id="header">
  <div class="intro text-center">
	...
	<br><br><h2>Feedback from Customers</h2><Br><br>
<table border=2 style="font-size:20px;" align="center" width=80%>
<tr><th>CustomerName</th><th>WorkerName</th><th>Message</th><th>Rating</th></tr>
...
{
%>
<Tr><th><%= rs.getString(1) %></th><th><%= rs.getString(2) %></th><th><%= rs.getString(3) %></th>
