...
<header id="header">
  <div class="intro text-center">
	...
	<h1 style="font-size:20px;float:right;">Welcome to Administrator<Br></h1>
			<br><br><Br><br>
    <a href="adminviewworks.jsp" style="font-size:25px;">View Works</a><br><br>
	<a href="adminviewworkers.jsp" style="font-size:25px;">View Workers</a><br><br>
	<a href="adminviewusers.jsp" style="font-size:25px;">View Customers</a><br><br>
		<a href="adminviewfeedback.jsp" style="font-size:25px;">View Feedback</a><br><br>
	<a href="index.html" style="font-size:25px;">LogOut</a><br><Br>
