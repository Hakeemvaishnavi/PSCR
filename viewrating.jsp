...
<header id="header">
  <div class="intro text-center">
	...
	<h1 style="font-size:20px;float:right;">Welcome to Workers,<%= session.getAttribute("UserName") %><Br><a href="workerhome.jsp">Back</a></h1>
			<br><br><h2>User Ratings</h2><Br><br>
<table border=2 style="font-size:20px;" align="center" width=80%>
<tr><th>CustomerName</th><th>Message</th><th>Rating</th></tr>
<%@include file="DBConn.jsp" %>
<%
String user=(String)session.getAttribute("UserName");
PreparedStatement pst=con.prepareStatement("select * from feedback where workername=?");
pst.setString(1,user);
ResultSet rs=pst.executeQuery();
while(rs.next())
{
%>
<Tr><th><%= rs.getString(1) %></th><th><%= rs.getString(3) %></th>
