...
<header id="header">
  <div class="intro text-center">
	...
	<h1 style="font-size:20px;float:right;">Welcome to Customer,<%= session.getAttribute("UserName") %><Br></h1>
			<br><br><Br><br>
			<table align="center" style="font-size:20px;">
			<form action="addworks1.jsp" method="post">
			<tr><th colspan=2>Enter Work Details</th></tr>
<tr><th><tr><th>Select Category</th><th><select name="category" style="color:black;">
...
<tr><th>Work Description</th><th><textarea rows=5 cols=20 name="desc" required style="color:black;"></textarea></th></tr>
<tr><th>Location</th><th><input type="text" name="location" required  style="color:black;"/><Br></th></tr>


<tr><th>Date of Work</th><th><input type="date" name="date" required  style="color:black;"/><Br></th></tr>
