...
<header id="header">
  <div class="intro text-center">
	...
	<h1 style="font-size:20px;float:right;">Welcome to Administrator<Br><a href="adminhome.jsp">Back</a></h1>
			<br><br><h2>Work Details</h2><Br><br>
    <table align="Center" style="font-size:20px;" border=2 width=80%>
<tr><Th>WorkId</th><th>Description</th><th>Location</th><th>AmountPerDay</th><th>PostedDate</th><th>Status</th><th>Customer Name</th><th>Category</th><th>DateOfWork</th></tr>

<%@include file="DBConn.jsp" %>
<%

PreparedStatement pst=con.prepareStatement("select * from works ");
...
%>
  ...
  <th><%= rs.getString(4) %></th>  <th><%= rs.getString(5) %></th><th><%= rs.getString(6) %></th>  <th><%= rs.getString(7) %></th><th><%= rs.getString(8) %></th>  <th><%= rs.getString(9) %></th></TR>
  <%
}
%>
</table>
